package treecree.enderscience.entity;
...
public class EntityMorph extends EntityLivingBase implements IEntityAdditionalSpawnData, IMorphProvider
{
    ...
    public ITextComponent getDisplayName()
    {
        if (this.morph != null)
        {
            return new TextComponentTranslation("entity." + ResourceReference.getResourceString(this.morph.resource) + ".name");
        }
    ...
    protected void grantMorph(EntityPlayer player)
    {
        ...
        if (MorphAPI.acquire(player, this.morph))
        {
           ...
           // ((WorldServer) this.world).getEntityTracker().sendToAllTrackingEntity(this, new SPacketCollectItem(this.getEntityId(), player.getEntityId()));
