package treecree.enderscience.client;
...
public class RenderingHandler
{
    ...
    private GuiOverlay2 morphOverlay2;
    private GuiHud hud;
    private RenderManager manager;

    public RenderingHandler(GuiOverlay morphOverlay, GuiOverlay2 morphOverlay2, GuiHud hud)
    {
        this.morphOverlay = morphOverlay;
        this.morphOverlay2 = morphOverlay2;
        this.hud = hud;
    ...
    public void onHUDRender(RenderGameOverlayEvent.Post event)
    {
        ...
        if (event.getType() == RenderGameOverlayEvent.ElementType.ALL)
        {
            ...
            this.morphOverlay2.render(resolution.getScaledWidth(), resolution.getScaledHeight());
        }
    }
